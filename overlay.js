google.maps.__gjsload__('overlay', function(_) {
    var Rx = function(a) {
      ...
      , Jpa = function(a, b) {
        ...
        _.jj(d.Ja);
        b instanceof _.lh ? (_.ai(b, "Ox"),
        _.Zh(b, 148440)) : b instanceof _.ri && (_.ai(b, "Oxs"),
        _.Zh(b, 181451))
    }
      , Opa = function(a) {
        if (a) {
            ...
            if (Kpa(a) !== b && b && b instanceof _.lh) {
                const c = b.__gm;
                c.overlayLayer ? a.__gmop = new Lpa(b,a,c.overlayLayer) : c.yb.then(({ka: d})=>{
                    const e = new Mpa(b,d);
                    d.Ub(e);
                    c.overlayLayer = e;
                    Npa(a);
    ...
    Rx.prototype.changed = function(a) {
        "outProjection" != a && (a = !!(this.get("offset") && this.get("projectionTopLeft") && this.get("projection") && _.Wf(this.get("zoom"))),
    ...
    _.Jg("overlay", {
        ...
        preventMapHitsAndGesturesFrom: a=>{
            ...
            a.addEventListener("MSPointerDown", _.Rg);
